...
return db('reservation as r').join('listing as l','r.listing_id','l.id').where('r.listing_id',null).orWhereNotBetween("r.start_date",[startDate,endDate]).andWhereNotBetween("r.end_date",[startDate,endDate]).select('r.*','l.*')
}
